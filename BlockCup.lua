...
MainFrame.Size = UDim2.new(0, 500, 0, 500) -- Tamaño cuadrado ampliadito para ambas opciones
MainFrame.Position = UDim2.new(0.5, -250, 0.1, 0)
MainFrame.BackgroundColor3 = Color3.new(0.1, 0.1, 0.1)
MainFrame.BackgroundTransparency = 0.1
MainFrame.BorderSizePixel = 0
MainFrame.CornerRadius = UDim.new(0, 20) -- Esquinas redondeadas
...
Option1Frame.CornerRadius = UDim.new(0, 15) -- Esquinas redondeadas
...
AutoKickToggle1.CornerRadius = UDim.new(0, 15) -- Esquinas redondeadas
...
Option2Frame.CornerRadius = UDim.new(0, 15) -- Esquinas redondeadas
...
AutoKickToggle2.CornerRadius = UDim.new(0, 15) -- Esquinas redondeadas
...
AutoCollectToggle.CornerRadius = UDim.new(0, 15) -- Esquinas redondeadas
...
CloseButton.CornerRadius = UDim.new(1, 0) -- Botón completamente redondo
...
local function FindLuckyBlock()
    local PossibleBlocks = Workspace:FindFirstChild("LuckyBlocks") or Workspace:FindFirstChild("Blocks") or Workspace
    ...
    for _, Block in ipairs(PossibleBlocks:GetChildren()) do
        if Block:IsA("BasePart") and Block.Name:find("Lucky") or Block.Name:find("Block") then
...
local function KickBlock(Block)
    ...
    -- Interacción segura con el bloque
